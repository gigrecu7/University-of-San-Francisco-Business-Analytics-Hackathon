...
write.csv(working_tweets_data,"/Users/derekwong/Documents/USF Work/Senior Year/Hackathon/USFBUANHACK2021/
          working_tweets_data.csv", row.names =  TRUE)
write.csv(working_price_data,"/Users/derekwong/Documents/USF Work/Senior Year/Hackathon/USFBUANHACK2021/
...
#Literally copied this but don't worry
library(tm)
library(SnowballC)
...
write.csv(df, "/Users/derekwong/Documents/USF Work/Senior Year/Hackathon/USFBUANHACK2021/
...
elon_df = data.frame(working_tweets_data$utc_date, dataset$elon, dataset$elondog, dataset$elonmusk,
                     dataset$musk)
write.csv(elon_df, "/Users/derekwong/Documents/USF Work/Senior Year/Hackathon/USFBUANHACK2021/
...
write.csv(buy_df, "/Users/derekwong/Documents/USF Work/Senior Year/Hackathon/USFBUANHACK2021/
...
View(top30)
write.csv(top30,"/Users/derekwong/Documents/USF Work/Senior Year/Hackathon/USFBUANHACK2021/
